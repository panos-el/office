...
@Component({
    ...
    template: `
        <div class="flex items-center justify-between relative lg:static py-12 px-6 mx-0 md:px-16 lg:px-20 lg:py-12 lg:mx-20">
            ...
            <a
                pRipple
                class="pi pi-bars text-4xl! cursor-pointer block md:hidden text-surface-700 dark:text-surface-100"
                pStyleClass="@next"
            ...
            <ul #menu style="top:80px; right: 0%;" class="list-none p-4 md:p-0 m-0 ml-auto flex md:items-center select-none flex-col md:flex-row cursor-pointer">
                <a
                    pRipple
                    class="cursor-pointer block md:hidden text-700 text-primary absolute z-5"
                    style="top:1.5rem;
                right: 1.5rem;"
                    pRipple
                    pStyleClass="@parent"
                ...
                <li>
                    <a
                        (click)="router.navigate(['/landing'], { fragment: 'apps' })"
                        pRipple
                        pStyleClass="@grandparent"
                        enterFromClass="ng-hidden"
                        enterActiveClass="px-fadein"
                ...
                <li class="flex align-items-center">
                    <button pButton pRipple type="button" pStyleClass="@grandparent" enterFromClass="ng-hidden" enterActiveClass="px-fadein" leaveToClass="ng-hidden" label="Buy Now" class="m-0 mt-4 md:mt-0 md:ml-8"></button>
                </li>
            </ul>
        </div>
    `
