import { AfterViewChecked, Component, ElementRef, HostBinding, inject, Input, OnDestroy, OnInit, ViewChild } from '@angular/core';
        ...
        <ng-container>
            ...
            <ul #submenu *ngIf="item.items && item.visible !== false" [@children]="submenuAnimation" (@children.done)="onSubmenuAnimated($event)">
                <ng-template ngFor let-child let-i="index" [ngForOf]="item.items">
                    <li client-menuitem [item]="child" [index]="i" [parentKey]="key" [class]="child['badgeClass']"></li>
                </ng-template>
            </ul>
        </ng-container>
    `,
...
export class ClientMenuitem implements OnInit, OnDestroy, AfterViewChecked {
    @Input() item: any;
