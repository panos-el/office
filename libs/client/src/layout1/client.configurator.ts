...
import { booleanAttribute, Component, computed, inject, Input, OnInit, PLATFORM_ID, signal } from '@angular/core';
...
export class ClientConfigurator implements OnInit {
