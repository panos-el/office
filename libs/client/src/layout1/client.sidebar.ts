...
import { ClientMenuProfile } from './client.menuprofile';
import { CommonModule } from '@angular/common';

@Component({
    selector: '[client-sidebar]',
    standalone: true,
    imports: [ClientMenu, RouterModule, ClientMenuProfile, CommonModule],
    template: ` <div class="layout-sidebar" (mouseenter)="onMouseEnter()" (mouseleave)="onMouseLeave()">
        ...
        <div client-menu-profile *ngIf="menuProfilePosition === 'start'"></div>
        <div class="layout-menu-container">
            <div client-menu></div>
        </div>
        <div client-menu-profile *ngIf="menuProfilePosition === 'end'"></div>
    </div>`
})
export class ClientSidebar {
    timeout: any = null;

    @ViewChild(ClientMenu) appMenu!: ClientMenu;
