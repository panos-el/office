...
//     providers: [
//         { provide: KendoGridToken, useExisting: forwardRef(() => KendoRemoteGridComponent) },
...
//         const url = `${this.baseUrl}${this.formOptions.propertiesUrl}?${toDataSourceRequestString(this.state as DataSourceRequestState)}`;
